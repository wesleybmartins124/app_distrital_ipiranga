...
import FabButtonavan from  '../../../src/components/FabButtonavan';
...
export default function Avançado({navigation}) {
...
style={[styles.imagenphoto]}
   ...
   <FlatList
     ...
     >
      ...
      <FabButtonavan style={{bottom: 100, right:55}} Interessados={() => navigation.navigate('Interessados')} oracao={() => navigation.navigate('oracao')} pedido={() => navigation.navigate('addProgramacao')}  NewPost={() => navigation.navigate('NewPost')}/>
