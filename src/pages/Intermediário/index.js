...
import  '../../config';
import FabButtonint from  '../../components/FabButtonint';

export default function Intermediário({navigation}) {
...
style={[styles.imagenphoto]}
   ...
   <FlatList
     ...
     >
        ...
        <FabButtonint style={{bottom: 100, right:55}} oracao={() => navigation.navigate('oracao')} pedido={() => navigation.navigate('addProgramacao')} NewPost={() => navigation.navigate('NewPost')} />
