...
if($postjson['idade'] == ''){
 ...
 $query_buscar = $pdo->query("SELECT * from interessados where nome_completo = '$postjson[nome_completo]' and cep_int = '$postjson[cep_int]' ");
 ...
 if(@count($dados_buscar) > 0){
 	...
 	$query = $pdo->prepare( "INSERT INTO interessados SET
      image = :image, 
